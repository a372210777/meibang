...
;(function ( $, window, document, undefined ) {
  ...
  Plugin.prototype = {
    ...
    showMenu: function() {
      ...
      this.$element.find('ul').removeClass("hide").addClass("show animate slideInDown");
      this.$element.find('.button:first').addClass('is-active');
    },

    hideMenu: function() {
      this.$element.data('dropdown', 'hide');
      this.$element.find('ul').addClass("hide").removeClass("show animate slideOutUp");
      this.$element.find('.button:first').removeClass('is-active');
    },
    initItem:function(){
      $.each(this.options.item,function(i,obj){
          console.log(obj.value);
          this.$element.find('ul').append("<li class='item'>"+obj.value+"</li>")
      }.bind(this))
    }
  };
